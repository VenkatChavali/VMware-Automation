...
def test_logger_creates_file():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Log file created: {exists}  OK")
        ...
        print(f"Contains INFO   : {has_info}    OK")
        print(f"Contains WARNING: {has_warning} OK")
        print(f"Contains ERROR  : {has_error}   OK")
...
def test_section_separator():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Separator line present: {has_separator}  OK")
        print(f"Arrow marker present  : {has_arrow}      OK")
...
def test_two_hosts_get_separate_files():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Host1 log exists: {file1.exists()}  OK")
        print(f"Host2 log exists: {file2.exists()}  OK")
        ...
        print(f"Host1 log is clean (no host2 messages): {host1_clean}  OK")
        print(f"Host2 log is clean (no host1 messages): {host2_clean}  OK")
